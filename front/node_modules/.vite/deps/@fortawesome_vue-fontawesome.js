...
function convert(abstractElement) {
  ...
  var _attrs$class = attrs.class, _attrs$style = attrs.style, aStyle = _attrs$style === void 0 ? {} : _attrs$style, otherAttrs = objectWithoutProperties(attrs, ["class", "style"]);
...
function normalizeIconArgs(icon$$1) {
  ...
  if ((typeof icon$$1 === "undefined" ? "undefined" : _typeof2(icon$$1)) === "object" && icon$$1.prefix && icon$$1.iconName) {
    return icon$$1;
  }
